...
export default function TransfersPage() {
  ...
  const quarantinedParam =
    quarantinedFilter === "true"
      ? true
      : quarantinedFilter === "false"
        ? false
        : undefined;
    ...
    <Page>
      ...
      <PageContainer width="list">
        <PageHero
          ...
          icon="💸"
          title="Transfers"
          description="Asset transfers and their settlement status."
          badge={{ label: "Transfers", note: data ? `${totalCount} total` : undefined }}
        />
        ...
        <TransfersFilters
          ...
          onQuarantinedChange={setQuarantinedFilter}
