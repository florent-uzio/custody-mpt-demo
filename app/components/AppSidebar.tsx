...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "cmpt-convert", label: "cMPT Convert", icon: "🔒", category: "Confidential MPT", href: "/mpt/confidential/convert" },
  { id: "cmpt-convert-back", label: "cMPT Convert Back", icon: "🔓", category: "Confidential MPT", href: "/mpt/confidential/convert-back" },
  { id: "cmpt-merge-inbox", label: "cMPT Merge Inbox", icon: "📥", category: "Confidential MPT", href: "/mpt/confidential/merge-inbox" },
  { id: "cmpt-send", label: "cMPT Send", icon: "🕶️", category: "Confidential MPT", href: "/mpt/confidential/send" },
  { id: "cmpt-compute", label: "cMPT Compute", icon: "🧮", category: "Confidential MPT", href: "/mpt/confidential/compute" },
  { id: "provision-elgamal", label: "Provision ElGamal", icon: "🔑", category: "Confidential MPT", href: "/intents/provision-elgamal" },
