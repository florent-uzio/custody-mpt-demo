...
import type { LockStatus, UserSortBy, SortOrder } from "./users.types";
import {
  Page,
  PageHeader,
  PageContainer,
...
export default function UsersPage() {
  ...
  const [lockFilter, setLockFilter] = useState<LockStatus | "">("");
  ...
  const {
    ...
    lock: lockFilter ? [lockFilter] : undefined,
    sortBy,
    sortOrder,
    limit,
  });
    ...
    <Page>
      ...
      <PageContainer width="list">
        <PageHero
          ...
          icon="👥"
          title="Users"
          description="Users in the selected domain and their roles."
          badge={{ label: "Users", note: data ? `${totalCount} total` : undefined }}
        />
        ...
        <UsersFilters
          ...
          onAliasChange={setAliasFilter}
          lockFilter={lockFilter}
          onLockChange={setLockFilter}
          limit={limit}
            ...
            <div className="divide-y divide-gray-50">
              {Array.from({ length: 5 }).map((_, i) => (
                ...
                >
                  ...
                  <div className="h-5 w-20 bg-gray-100 rounded hidden md:block" />
