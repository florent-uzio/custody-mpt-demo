...
import type { TrustedUser, UserSortBy, SortOrder } from "../users.types";
          ...
          <tbody className="divide-y divide-gray-50">
            {users.map(({ data: user }) => (
              ...
              >
                ...
                <td className="px-4 py-3 hidden lg:table-cell text-gray-500 text-xs whitespace-nowrap">
                  {formatDate(user.metadata.lastModifiedAt)}
                </td>
                <td className="px-4 py-3 text-right">
                  <Link
                    href={`/users/${user.id}?domainId=${domainId}`}
