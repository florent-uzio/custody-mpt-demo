...
export default function AccountsPage() {
  ...
  const toggleArray = (
    field: "locks" | "additionalLedgerStatuses",
    val: string,
  ) => {
    setFilters((prev) => ({
      ...prev,
  ...
  const buildActionFilters = (): ActionFilters => {
    ...
    if (filters.customProperties)
      f.customProperties = filters.customProperties
        .split(",")
        .map((p) => p.trim())
        .filter(Boolean);
    ...
    if (filters.additionalLedgerIds)
      f.additionalLedgerIds = filters.additionalLedgerIds
        .split(",")
        .map((s) => s.trim())
        .filter(Boolean);
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setField("processingStatus", e.target.value)
                    }
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setField("additionalLedgerIds", e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setField("customProperties", e.target.value)
                    }
                    ...
                    {LEDGER_STATUS_OPTIONS.map((val) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            toggleArray("additionalLedgerStatuses", val)
                          }
                          className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
                      ...
                      >
                        ...
                        <td className="px-4 py-3 hidden sm:table-cell">
                          <span className="font-mono text-xs text-gray-500">
                            {item.data.ledgerId ||
                              item.additionalDetails?.ledgers?.find(
                                (l) => l.status === "Activated",
                              )?.ledgerId || (
                        ...
                        <td className="px-4 py-3 hidden lg:table-cell">
                          {item.additionalDetails?.processing?.status ? (
                            <StatusBadge
                              value={item.additionalDetails.processing.status}
                              styles={PROCESSING_STYLES}
                            />
                          ) : (
                            <span className="text-gray-300 text-xs">—</span>
                          )}
          ...
          {!isLoading && data && items.length === 0 && (
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-12 flex flex-col items-center text-center">
